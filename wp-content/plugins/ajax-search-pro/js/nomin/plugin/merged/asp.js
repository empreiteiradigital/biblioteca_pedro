...
(function() {
    ...
    WPD.dom.fn.inViewPort = function (tolerance, viewport) {
        ...
        viewport = typeof viewport == 'undefined' ? window : document.querySelector(viewport);
...
(function($){
    ...
    let functions = {
        showResults: function( ) {
            ...
            $this.n.resultsDiv.find('.item').on('mouseenter', function () {
                    $('.item', $this.n.resultsDiv).removeClass('hovered');
                    $(this).addClass('hovered');
                }
            );
            $this.n.resultsDiv.find('.item').on('mouseleave', function () {
                    $('.item', $this.n.resultsDiv).removeClass('hovered');
                }
            );
    ...
    let functions = {
        ...
        checkAndTriggerInfiniteScroll: function( caller ) {
            ...
            if ( caller == 'window' || caller == 'horizontal' ) {
                ...
                let onViewPort = $r.last().inViewPort(0, '.asp_r_' + $this.o.rid),
            ...
            if (ignoreVisibility == true || $this.n.resultsDiv.css('visibility') == 'visible') {
                ...
                if ( typeof _rposition != 'undefined' ) {
                    ...
                    if ( $this.o.resultsSnapTo == 'right' ) {
                        adjust = parseInt(vwidth) - $this.n.search.outerWidth();
                    } else if (( $this.o.resultsSnapTo == 'center' )) {
                        adjust = Math.floor( (parseInt(vwidth) - parseInt($this.n.search.outerWidth())) / 2 );
                    }
            ...
            if ($this.o.resultstype == "isotopic") {
                if ($this.o.isotopic.showOverlay) {
                    ...
                    if ( !helpers.detectIOS() ) {
                        $this.n.resultsDiv.find('div.item').on('mouseenter', function () {
                        ...
                        $this.n.resultsDiv.find('div.item').on('mouseleave', function () {
                        ...
                        $this.n.resultsDiv.find('div.asp_item_inner').on('mouseenter', function () {
                            $(this).addClass('animated pulse');
                        });
                        $this.n.resultsDiv.find('div.asp_item_inner').on('mouseleave', function () {
                            $(this).removeClass('animated pulse');
                        });
                    }

                    $this.n.resultsDiv.find('.asp_isotopic_item').on('click', function(e){
                        if ( !$this.dragging ) {
            ...
            let handler = function (e) {
                ...
                if (
                    ...
                    if ( keycode == 40 || keycode == 38 ) {
                        ...
                        e.stopPropagation();
                        e.preventDefault();
                        if ( !$this.n.resultsDiv.find('.resdrg .item.hovered').inViewPort(50, '.asp_r_' + $this.o.rid) ) {
    ...
    let functions = {
        ...
        initPrevState: function() {
            ...
            if ( _static.prevState != null && typeof _static.prevState.id != 'undefined' ) {
                if ( _static.prevState.id == $this.o.id && _static.prevState.instance == $this.o.iid ) {
